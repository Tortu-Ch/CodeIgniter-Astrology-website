        ...
        <section class="section-60 section-lg-bottom-110 section-md-right bg-ebony-clay text-md-left">
          <div class="shell">
            <div class="range range-md-justify range-md-reverse">
              ...
              <div class="cell-md-6">
                <div class="section-img"><img src="assets/images/blog-1-842x584.jpg" alt="" width="842" height="584" class="img-responsive"/>
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="section-60 section-lg-bottom-110 section-md-left bg-ebony-clay text-md-left">
          <div class="shell">
            <div class="range">
              ...
              <div class="cell-md-6">
                <div class="section-img"><img src="assets/images/blog-2-842x584.jpg" alt="" width="842" height="584" class="img-responsive"/>
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="section-60 section-lg-bottom-110 section-md-right bg-ebony-clay text-md-left">
          <div class="shell">
            <div class="range range-md-justify range-md-reverse">
              ...
              <div class="cell-md-6">
                <div class="section-img"><img src="assets/images/blog-3-842x584.jpg" alt="" width="842" height="584" class="img-responsive"/>
                </div>
              </div>
            </div>
          </div>
        ...
        <section class="section-60 section-lg-bottom-110 section-md-left bg-ebony-clay text-md-left">
          <div class="shell">
            <div class="range">
              ...
              <div class="cell-md-6">
                <div class="section-img"><img src="assets/images/blog-4-842x584.jpg" alt="" width="842" height="584" class="img-responsive"/>
                </div>
              </div>
            </div>
          </div>
